...
python3 main.py compas_age 0.005 0.5,0.5,0.5 $PATH_TO_COMPAS_RESULTS/age/compas_age_CFA_theta=05.csv
echo "Baseline with CFA theta = 1"
python3 main.py compas_age 0.005 1,1,1 $PATH_TO_COMPAS_RESULTS/age/compas_age_CFA_theta=1.csv
