...
java -jar Multinomial_FA-IR.jar data $PATH_TO_COMPAS_DATA/compas_ageRace_java.csv 100 0.209,0.573,0.218 0.1 $PATH_TO_COMPAS_RESULTS/ageRace/compas_ageRace
