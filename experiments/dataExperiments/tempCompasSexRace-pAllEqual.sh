...
java -jar Multinomial_FA-IR.jar data $PATH_TO_COMPAS_DATA/compas_sexRace_java.csv 200 0.25,0.25,0.25,0.25 0.1 $PATH_TO_COMPAS_RESULTS/sexRace/compas_sexRace
