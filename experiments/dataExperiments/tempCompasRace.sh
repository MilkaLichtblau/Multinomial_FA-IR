...
java -jar Multinomial_FA-IR.jar data $PATH_TO_COMPAS_DATA/compas_race_java.csv 1500 0.66,0.34 0.1 $PATH_TO_COMPAS_RESULTS/race/compas_race

# p is all the same
echo "Multi FAIR with p all equal"
java -jar Multinomial_FA-IR.jar data $PATH_TO_COMPAS_DATA/compas_race_java.csv 1500 0.5,0.5 0.1 $PATH_TO_COMPAS_RESULTS/race/compas_race
