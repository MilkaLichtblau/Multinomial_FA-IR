...
python3 main.py compas_sexAge 0.05 0.5,0.5,0.5,0.5 $PATH_TO_COMPAS_RESULTS/sexAge/compas_sexAge_CFA_theta=05.csv
echo "Baseline with CFA theta = 1"
python3 main.py compas_sexAge 0.05 1,1,1,1 $PATH_TO_COMPAS_RESULTS/sexAge/compas_sexAge_CFA_theta=1.csv
