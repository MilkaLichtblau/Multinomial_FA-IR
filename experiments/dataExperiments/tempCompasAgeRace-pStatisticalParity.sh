...
java -jar Multinomial_FA-IR.jar data $PATH_TO_COMPAS_DATA/compas_ageRace_java.csv 100 0.18,0.11,0.1,0.39,0.06,0.16 0.1 $PATH_TO_COMPAS_RESULTS/ageRace/compas_ageRace
