...
java -jar Multinomial_FA-IR.jar data $PATH_TO_COMPAS_DATA/compas_worstThreeGroups_java.csv 200 0.826,0.028,0.012,0.134 0.1 $PATH_TO_COMPAS_RESULTS/worstThree/compas_worstThreeGroups
