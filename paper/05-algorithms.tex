...
\note[ChaTo]{I suggest to move this entire subsection (\S\ref{subsec:algorithm-optimization}) to the previous section (\S\ref{sec:alpha-adjustment}). That way here we would assume the mTrees were already created in the best/cheapest possible way.}
