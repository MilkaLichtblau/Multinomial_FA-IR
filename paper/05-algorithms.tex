...
Because the computation of an adjusted mTree is expensive (Table~\ref{tbl:time-space}), our implementation persists already computed mTrees and their components to never do the same computation twice. 
%
