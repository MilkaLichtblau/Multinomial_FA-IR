...
%
\inote{Next sentence is a little bit unclear, perhaps rephrase? -- ChaTo}
...
\note[ChaTo]{I think the point is clear. The example is good but could be omitted (or kept, I'm indifferent).}
