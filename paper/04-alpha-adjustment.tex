...
%
The complexity analysis for \algoFAIR is done in Subsection~\ref{subsubsec:FAIR-complexity}, but Table~\ref{tbl:time-space} already contains the summary, such that it shows time and space complexity for all algorithms in this paper.
