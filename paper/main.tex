...
%
Ranking is required for different tasks, including search, personalization, recommendation, and selection.
%
...
%
These constraints are needed in order to correct implicit societal biases existing in the inpur data and reflected in the relevance or fitness score computed.
%
In this work, we study the Fair Top-$k$ Ranking problem, in which we want to determine a subset of $k$ candidates from a large pool of $n \gg k$ candidates, maximizing utility ({\em i.e.}, select the ``best'' candidates) subject to a group-fairness criteria.
%
