...
\usepackage{makecell,xcolor,amsmath}
...
\newcommand{\alphaadj}[0]{\ensuremath{\alpha_c}}
...
\newcommand{\algoBinomBinary}[0]{{\sc BinarySearchAlphaAdjustment}\xspace}
\newcommand{\algoComputeMTree}[0]{{\sc ComputeMTree}\xspace}
\newcommand{\algoImcdf}[0]{{\tt InverseMultinomialCDF}\xspace}
\newcommand{\algoReg}[0]{{\tt RegressionAdjustment}\xspace}
\newcommand{\algoMtable}[0]{{\tt ConstructMTable}\xspace}
\newcommand{\algoMultBinary}[0]{{\sc MultinomialBinarySearchAlphaAdjustment}\xspace}
...
% TITLE
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Ensuring Ranked Group Fairness Criteria for Multiple Protected Groups with \methodname}
%\title{Extension of \methodname to Multinomial Use Cases}
...
\affiliation{
	...
	\streetaddress{Rudower Chausee 25}
	\postcode{12489}
	\city{Berlin}
	\country{Germany}
}
