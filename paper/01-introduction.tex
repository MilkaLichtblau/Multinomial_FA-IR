...
%
We furthermore note that different manifestations of such bias exists for each group and is usually stronger for intersectional groups, i.e. the pre-existing bias against black women is stronger than the one for women or blacks in general.
