...
\begin{table}[t]
	...
	\resizebox{1.02\columnwidth}{!}{%
		\centering\begin{tabular}{llcccccc}\toprule
			&        & Exposure &   NDCG    & Ordering     & Rank & Selection \\
			& Method & gain per group  & loss  & utility loss & drop & utility loss \\ \midrule
			D1  & Colorblind & 0.0 & 1.0000 & 0.0000 & 0 & 0.0000 \\
			COMPAS, & \algoFAIR &  & \textbf{} & \textbf{} & \textbf{} & \textbf{} \\
			race & \citeauthor{zehlike2020matching} &  &  &  &  &  \\ \midrule
			
			D2 & Colorblind & 0.0 & 1.0000 & 0.0000 & 0 & 0.0000 \\
			COMPAS, & \algoFAIR p=0.8 &  & \textbf{} & \textbf{} & \textbf{} & \textbf{} \\
			age& \citeauthor{zehlike2020matching} &  &  &  &  &  \\ \midrule
			
			D3 & Colorblind & 0.0 & 1.0000 & 0.0000 & 0 & 0.0000 \\
			COMPAS, & \algoFAIR p=0.2 &  & \textbf{} & \textbf{} & \textbf{} & \textbf{} \\
			age, sex, race & \citeauthor{zehlike2020matching} &  &  &  &  &  \\ \midrule
			
			D4  & Colorblind & 0.0 & 1.0000 & 0.0000 & 0 & 0.0000 \\
			German credit, & \algoFAIR p=0.7 &  & \textbf{} & \textbf{} & \textbf{} & \textbf{} \\
			sex, age & \citeauthor{zehlike2020matching} &  &  &  &  &  \\ \midrule
			
			D5  & Colorblind & 0.0 & 1.0000 & 0.0000 & 0 & 0.0000 \\
			LSAT,& \algoFAIR p=0.2 &  & \textbf{} & \textbf{} & \textbf{} & \textbf{} \\
			sex, race & \citeauthor{zehlike2020matching} &  &  &  &  & \textbf{} \\			
			\bottomrule
		\end{tabular}
	}
	\vspace{-3mm}
