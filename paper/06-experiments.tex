...
\spara{Baseline 1: Color-blind ranking.} The ranking $\textit{cb}|_k$ that only considers the qualifications of the candidates, without considering group fairness, as described in Section~\ref{concept:color-blind-ranking}.
...
\begin{table}[b!]
	...
	\caption{Experimental results. 
		...
		%
		All measures are presented per group except for the loss of NDCG which is calculated for the entire ranking and groups are ordered the same way as in Table~\ref{tbl:datasets}.
		%
