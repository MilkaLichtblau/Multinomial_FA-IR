...
\begin{table}[h]
	\resizebox{1.01\columnwidth}{!}{%
		\centering\begin{tabular}{clcclllc}\toprule
			...
			\midrule
			D2 & COMPAS \cite{angwin_2016_machine}& 6173 & 1500 & ad-hoc score & < 25yr. & 21.8\% \\
			& & & & & 25yr. < x < 45yr. & 57.2\% \\
			\midrule
			D3 & COMPAS \cite{angwin_2016_machine}& 6173 & 500 & recidivism + & PoC male & 54.7\%\\ 
			& & & & prior arrests + & white male & 26.3\% \\
			& & & & violent recidivism & PoC female & 11.2\% \\
			\midrule
			D4 & COMPAS \cite{angwin_2016_machine}& 6173 & 500 & recidivism + & PoC female, < 25yr. & 2.8\%\\ 
			& & & & prior arrests + & white female, < 25yr. & 1.2\% \\
			& & & & violent recidivism & PoC male, < 25yr. & 13.4\% \\
			\midrule
			D5 & German credit \cite{lichman_2013_uci} & 100 & 500 & credit rating & female, non-prot. age & 21.7\% \\
			& & & & & male, oldest 10\% & 6.3\% \\
			& & & & & female, youngest 10\% & 6.1\% \\
			& & & & & male, youngest 10\% & 4.4\% \\
			& & & & & female, oldest 10\% & 3.2\% \\
			\midrule
			D6 & LSAT \cite{wightman1998lsac}  & 21K & 500  & LSAT score  & White, female & 35.3\%  \\ 
			& & & & & PoC, female & 8.4\% \\
			& & & & & PoC, male & 7.6\% \\
			\bottomrule
		\end{tabular}
