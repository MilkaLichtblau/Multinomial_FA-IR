...
%
The only parameter in which mTrees can not be recycled easily, is if $p_G$ changes. 
%
However, in many cases $p_G$ will most certainly be determined by policy, company guidelines or demographic data, which should change not often.}
