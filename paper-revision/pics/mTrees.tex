...
\begin{figure}[t!]
	...
	For instance, the node marked ``(5, [1, 2])$^*$'' indicates that in the first 5 positions of this ranking, one of the acceptable configurations is to have 1 or more elements from group 1 and 2 or more elements from group 2.}
	%
