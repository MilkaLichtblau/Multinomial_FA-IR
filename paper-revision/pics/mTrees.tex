...
\begin{figure}[t!]
	...
	%
	Levels go from left to right starting from 1, as indicated by the first number in the nodes. For instance, the node marked ``4, [0,2]$^*$'' indicates that when 4 elements are present (level 4), one of the acceptable configurations is to have 2 or more elements from group 1 and 0 or more elements from group 2.
	%
