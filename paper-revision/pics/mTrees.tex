...
\begin{figure}[t!]
	...
	For instance, the node marked ``4, [0,2]$^*$'' indicates that in the first 4 positions of a ranking of size 9, one of the acceptable configurations is to have 2 or more elements from group 1 and 0 or more elements from group 2.
	%
