...
\end{inparaenum}
%
\changed{Other work speaks of \emph{inter-} and \emph{intra-group fairness}~\cite{grgic2017fairness, yeom2021avoiding, beutel2019fairness}, where inter-group fairness is concerned with fair assignment of outcomes for items from different groups, and intra-group fairness relates to items that belong to the same group.
%
}
