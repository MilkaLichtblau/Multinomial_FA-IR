...
%
In this article, we tackle the problem of selecting a subset of $k$ individuals from a pool of $n \gg k$ candidates, maximizing global utility ({\em i.e.}, select the ``best'' candidates) while respecting given group-fairness criteria. In particular, to tackle this \emph{Fair Top-$k$ Ranking} problem, we adopt a ranked group-fairness definition which extends the standard notion of  group fairness based on protected groups, by
