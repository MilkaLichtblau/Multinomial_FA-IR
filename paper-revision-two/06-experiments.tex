...
\begin{table}[t!]
	\caption{Experimental results, showing changes in the average group exposure and ranking utility in terms of NDCG.
		...
		%
		We report mean and standard deviation of all metrics for the dice roll baseline. 
		%
		Note however, that these are just result statistics which do not relate to a specific ranking.
		%
